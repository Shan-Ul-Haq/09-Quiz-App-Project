...
if (mcqs.Q1 === "Java Script")  {console.log(chalk.bold.greenBright ("Ans # 01: You are Excellent!!"))}
else  {console.log(chalk.bold.italic.red ("Ans # 01: You are Fail!!"))}

if (mcqs.Q2 === "TypeScript is a superset of JavaScript")  {console.log(chalk.bold.greenBright ("Ans # 02: You are Excellent!!"))}
else  {console.log(chalk.bold.italic.red ("Ans # 02: You are Fail!!"))}

if (mcqs.Q3 === "String, Number, Boolean, Undefined, Null")  {console.log(chalk.bold.greenBright ("Ans # 03: You are Excellent!!"))}
else  {console.log(chalk.bold.italic.red ("Ans # 03: You are Fail!!"))}

if (mcqs.Q4 === "Addition, Subtraciton, Multiplication, Division, Exponentiation, Modulus")  {console.log(chalk.bold.greenBright ("Ans # 04: You are Excellent!!"))}
else  {console.log(chalk.bold.italic.red ("Ans # 04: You are Fail!!"))}
